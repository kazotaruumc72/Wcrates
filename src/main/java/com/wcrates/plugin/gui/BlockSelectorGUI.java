...
public class BlockSelectorGUI {
    ...
    // Comprehensive list of vanilla blocks from 1.0 (Beta 1.8) to 1.21.11
    private static final List<String> ALL_BLOCKS = Arrays.asList(
        // Classic blocks (1.0 - Beta 1.8 and early releases) - Essential blocks from the very beginning
        "BARRIER", "BEDROCK", "SPONGE", "WET_SPONGE",
        ...
        "POLISHED_BASALT", "GLOWSTONE", "CARVED_PUMPKIN", "JACK_O_LANTERN",

        // Early version blocks (1.0-1.15) - Redstone, rails, plants, and more
        "REDSTONE_ORE", "REDSTONE_BLOCK", "REDSTONE_TORCH", "LEVER", "STONE_PRESSURE_PLATE",
        "OAK_PRESSURE_PLATE", "STONE_BUTTON", "OAK_BUTTON", "DISPENSER", "DROPPER",
        "PISTON", "STICKY_PISTON", "HOPPER", "COMPARATOR", "REPEATER",
        "DAYLIGHT_DETECTOR", "OBSERVER", "NOTE_BLOCK", "RAIL", "POWERED_RAIL",
        "DETECTOR_RAIL", "ACTIVATOR_RAIL", "COBWEB", "GRASS", "FERN",
        "DEAD_BUSH", "DANDELION", "POPPY", "BLUE_ORCHID", "ALLIUM",
        "AZURE_BLUET", "RED_TULIP", "ORANGE_TULIP", "WHITE_TULIP", "PINK_TULIP",
        "OXEYE_DAISY", "SUNFLOWER", "LILAC", "ROSE_BUSH", "PEONY",
        "LARGE_FERN", "BROWN_MUSHROOM", "RED_MUSHROOM", "BROWN_MUSHROOM_BLOCK", "RED_MUSHROOM_BLOCK",
        "MUSHROOM_STEM", "CACTUS", "SUGAR_CANE", "LILY_PAD", "VINE",
        "IRON_BARS", "GLASS_PANE", "ENCHANTING_TABLE", "BREWING_STAND", "CAULDRON",
        "ENDER_CHEST", "END_PORTAL_FRAME", "DRAGON_EGG", "BEACON", "ANVIL",
        "CHIPPED_ANVIL", "DAMAGED_ANVIL", "IRON_TRAPDOOR", "SPRUCE_FENCE", "BIRCH_FENCE",
        "JUNGLE_FENCE", "ACACIA_FENCE", "DARK_OAK_FENCE", "SPRUCE_FENCE_GATE", "BIRCH_FENCE_GATE",
        "JUNGLE_FENCE_GATE", "ACACIA_FENCE_GATE", "DARK_OAK_FENCE_GATE", "BIRCH_DOOR", "SPRUCE_DOOR",
        "JUNGLE_DOOR", "ACACIA_DOOR", "DARK_OAK_DOOR", "IRON_DOOR", "OAK_DOOR",
        "BIRCH_TRAPDOOR", "SPRUCE_TRAPDOOR", "JUNGLE_TRAPDOOR", "ACACIA_TRAPDOOR", "DARK_OAK_TRAPDOOR",
        "OAK_TRAPDOOR", "BLUE_ICE", "FROSTED_BLUE_ICE", "SEA_PICKLE", "CONDUIT",
        "KELP", "DRIED_KELP_BLOCK", "TURTLE_EGG", "CORAL_BLOCK", "TUBE_CORAL_BLOCK",
        "BRAIN_CORAL_BLOCK", "BUBBLE_CORAL_BLOCK", "FIRE_CORAL_BLOCK", "HORN_CORAL_BLOCK", "DEAD_TUBE_CORAL_BLOCK",
        "DEAD_BRAIN_CORAL_BLOCK", "DEAD_BUBBLE_CORAL_BLOCK", "DEAD_FIRE_CORAL_BLOCK", "DEAD_HORN_CORAL_BLOCK", "TUBE_CORAL",
        "BRAIN_CORAL", "BUBBLE_CORAL", "FIRE_CORAL", "HORN_CORAL", "DEAD_TUBE_CORAL",
        "DEAD_BRAIN_CORAL", "DEAD_BUBBLE_CORAL", "DEAD_FIRE_CORAL", "DEAD_HORN_CORAL", "TUBE_CORAL_FAN",
        ...
        "AZALEA_LEAVES", "FLOWERING_AZALEA_LEAVES", "SPORE_BLOSSOM", "GLOW_LICHEN",
